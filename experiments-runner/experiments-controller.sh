...
# Also prepare base64-encoded selection for remote scripts and mark selection made
...
# Wrapper to maintain compatibility with previous revert callsite
fe_revert_done() { revert_done_batch; }
