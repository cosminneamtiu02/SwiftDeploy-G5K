...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --execute-command) EXEC_CMD="$2"; shift 2;;
    --full-path) FULL_PATH="$2"; shift 2;;
    --params-file) PARAMS_FILE="$2"; shift 2;;
    --collection-json) COLLECTION_JSON="$2"; shift 2;;
